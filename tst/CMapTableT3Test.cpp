...
typedef CMapTableT3<TItem, 50, 600> CItemList;

TEST_GROUP(CMapTableT3Grp)
{
  void setup()
  {
...
TEST(CMapTableT3Grp, add50del50)
{
   CItemList list;
   unsigned int index = 0;
   TItem item = {0};
...
TEST(CMapTableT3Grp, add50while_del)
{
   CItemList list;
   unsigned int index = 0;
